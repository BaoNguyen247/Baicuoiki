...
public class EmployeeGUI extends JFrame {
	...
	private void sortAscending() {
		displayArea.setText("Danh sách nhân viên (lương tăng dần):\n");
		List<Employee> sorted = manager.getEmployeesSortedBySalary(true);
		if (sorted.isEmpty()) {
			displayArea.append("Chưa có nhân viên nào trong danh sách.\n");
		} else {
			sorted.forEach(this::appendEmployeeToDisplay);
		}
	}

	private void sortDescending() {
		displayArea.setText("Danh sách nhân viên (lương giảm dần):\n");
	...
	private void displayEmployees() {
		...
		if (employees.isEmpty()) {
			...
			employees.forEach(this::appendEmployeeToDisplay);
		}
	}
